...
import { Loader2, Lock, Workflow } from 'lucide-react';
            ...
            <div className={cn(!canAccess && "blur-sm pointer-events-none")}>
                <header className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
                    <div className="space-y-1">
                     ...
                     <Button disabled={!canAccess}>Create Workflow</Button>
                </header>
            ...
            {!canAccess && (
                 <div className="absolute inset-4 flex flex-col items-center justify-center rounded-lg bg-background/80 backdrop-blur-sm z-10">
                    <div className="text-center p-8">
                        ...
                        <h2 className="text-2xl font-bold mb-2">Workflow Builder is an Enterprise feature</h2>
                        <p className="text-muted-foreground mb-6 max-w-md">
                            Automate complex tasks and build custom logic with our powerful drag-and-drop workflow builder.
                        </p>
                        <Button asChild>
