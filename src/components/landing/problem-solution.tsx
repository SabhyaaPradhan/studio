...
export default function ProblemSolution() {
  ...
  return (
    <section ref={ref} className={cn("py-20 md:py-32 bg-black", isVisible ? "animate-fade-in-up" : "opacity-0")}>
      <div className="container mx-auto px-4 md:px-6 text-center">
        <h2 className="text-3xl md:text-5xl font-bold text-white tracking-tighter">
          You're losing time answering the same questions.
        </h2>
        <p className="mt-6 max-w-3xl mx-auto text-lg md:text-xl text-neutral-300">
